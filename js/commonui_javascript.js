function execute_comment(){
    ...
    window.setInterval(function(){
        ...
        let tabMenuModal=document.querySelector(`[targetindex='tabMenuModal']`);

        let tabMenuModal_isactive=tabMenuModal.style.display=='block'?true:false;
        if(tabMenuModal_isactive){
            document.documentElement.style.overflow='hidden';
        }else{
            document.documentElement.style.overflow='visible';
        }
